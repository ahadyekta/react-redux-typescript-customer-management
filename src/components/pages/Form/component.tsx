            ...
            <div>
                <div className={"col-md-12 form-wrapper"}>
                    ...
                    {(!this.props.isEdit || this.props.customer) &&
                        <form id={"post-form"} onSubmit={this.processFormSubmission} noValidate={true}>
                            <div className="form-group col-md-12">
                                <label htmlFor="first_name"> First Name </label>
                                <input type="text" id="first_name" onChange={(e) => this.handleInputChanges(e)} name="first_name" className="form-control" placeholder="Customer's first name" defaultValue={this.state.first_name}/>
                            </div>

                            <div className="form-group col-md-12">
                                <label htmlFor="last_name"> Last Name </label>
                                <input type="text" id="last_name" onChange={(e) => this.handleInputChanges(e)} name="last_name" className="form-control" placeholder="Customer's last name" defaultValue={this.state.last_name} />
                            </div>

                            <div className="form-group col-md-12">
                                <label htmlFor="DOB"> Date of Birth </label>
                                <input type="text" id="DOB" onChange={(e) => this.handleInputChanges(e)} name="DOB" className="form-control" placeholder="24/03/1988"  defaultValue={this.state.DOB}/>
                            </div>
